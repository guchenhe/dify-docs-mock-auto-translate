...
description: "Dive into Dify through an example app - updated guide"
icon: "forward"
---

This comprehensive step-by-step tutorial will walk you through creating a powerful multi-platform content generator from scratch.
...
Click the Start node (not **\+**) to open its configuration panel, then add the following input fields.
...
3. Click **Run** in the top-right corner, fill in the input fields, then click **Start Run**.
