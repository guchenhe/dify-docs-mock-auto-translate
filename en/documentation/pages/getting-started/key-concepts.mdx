...
Dify is specifically designed for building sophisticated agentic applications. In **Studio**, you can rapidly create advanced agentic workflows through an intuitive drag & drop interface and seamlessly publish them as production-ready apps. You can access published apps via API, the web, or as an [MCP server](/en/guides/application-publishing/publish-mcp). Dify offers two main app types: workflow and chatflow. You will need to choose an app type when creating a new app.
