...
<Card title="Advanced Access Management" icon="shield-check" href="/en/documentation/pages/publish/web-app-access">
...
<CardGroup cols={2}>
  ...
  <Card title="Website Embedding" icon="window" href="/en/documentation/pages/publish/embedding-in-websites">
...
[Edit this page](https://github.com/langgenius/dify-docs/edit/main/en/documentation/pages/publish/webapp/web-app-settings.mdx) | [Report an issue](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
