...
<Tip>
Please refer to [Select the Indexing Method and Retrieval Setting](/en/documentation/knowledge/create-knowledge/setting-indexing-methods) for more details.
</Tip>
...
[Edit this page](https://github.com/langgenius/dify-docs/edit/main/en/documentation/pages/knowledge/knowledge-pipeline/knowledge-pipeline-orchestration.mdx) | [Report an issue](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
