...
[Edit this page](https://github.com/langgenius/dify-docs/edit/main/en/self-hosting/advanced-deployments/local-source-code.mdx) | [Report an issue](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
