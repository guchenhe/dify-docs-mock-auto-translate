...
If you have any questions, please refer to [FAQs](/en/self-hosting/quick-start/faqs).
...
[Edit this page](https://github.com/langgenius/dify-docs/edit/main/en/self-hosting/quick-start/docker-compose.mdx) | [Report an issue](https://github.com/langgenius/dify-docs/issues/new?template=docs.yml)
